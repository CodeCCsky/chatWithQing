...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "初始化设置"))
        ...
        item.setText(_translate("MainWindow", "历史记录与对话设置"))
        ...
        self.historyLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt;\">设置要加载的历史记录</span></p><p><span style=\" font-size:10pt;\">加载历史记录功能因为历史记录模块的修改暂时不可用</span></p><p><span style=\" font-size:10pt;\">还没想好怎么改这个功能...</span></p></body></html>"))
