...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.retryButton.setStyleSheet("QPushButton{color:red;font-weight:bold;}")
        ...
        Form.setTabOrder(self.clearButton, self.pushButton)

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Form"))
        self.retryButton.setText(_translate("Form", "重新发送"))
